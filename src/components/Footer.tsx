...
const socials = [
  ...
  { icon: "fab fa-whatsapp",  href: "https://wa.me/5511945806717",                label: "WhatsApp" },
];
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-2">
              ...
              <a href="tel:+5511945806717" className="hover:text-primary transition-colors">
                (11) 94580-6717
              </a>
            </li>
            <li className="flex items-start gap-2">
              <i className="fas fa-envelope text-primary mt-0.5" />
              <a href="mailto:comercial@jobelly.com.br" className="hover:text-primary transition-colors break-all">
                comercial@jobelly.com.br
              </a>
            </li>
            <li className="flex items-start gap-2">
