...
const allItems = [
  ...
  { cat: "canetas" as Category, img: canetaMetalColors, title: "Caneta Metálica Multicolor", desc: "Alumínio fosco, 9 cores disponíveis" },
  ...
  { cat: "canetas" as Category, img: canetaMetalSlimFosca, title: "Caneta Metal Slim Fosca", desc: "Acabamento matte premium, 9 tons neutros" },
  ...
  { cat: "canetas" as Category, img: canetaRoseGold, title: "Caneta Rosé Gold", desc: "Detalhes dourados rosé, 3 cores elegantes" },
  { cat: "canetas" as Category, img: canetaBicolorRose, title: "Caneta Bicolor Rosé", desc: "Corpo bicolor preto + cor, clip rosé gold, 6 opções" },
  ...
  { cat: "mochilas" as Category, img: mochilaCarbonPreta, title: "Mochila Carbon Executiva", desc: "Textura carbon, compartimento notebook, cinza" },
  { cat: "mochilas" as Category, img: mochilaCarbonPreta2, title: "Mochila Carbon Black", desc: "Textura carbon, toda preta, visual sofisticado" },
  { cat: "mochilas" as Category, img: mochilaAzulSlim, title: "Mochila Slim Azul Marinho", desc: "Perfil slim, zíper lateral, base em PU" },
  { cat: "mochilas" as Category, img: mochilaSacoCortica, title: "Mochila Saco Algodão + Cortiça", desc: "Sustentável, base em cortiça natural" },
  // Cadernos
