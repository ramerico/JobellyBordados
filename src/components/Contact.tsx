...
const contactItems = [
  ...
  },
  {
    ...
    lines: ["(11) 94580-6717"],
    link: "tel:+5511945806717",
  },
  {
    icon: Mail,
    title: "E-mail",
    lines: ["comercial@jobelly.com.br"],
    link: "mailto:comercial@jobelly.com.br",
  },
  {
    icon: Clock,
...
const socials = [
  ...
  },
  {
    ...
    href: "https://wa.me/5511945806717",
    label: "WhatsApp",
    ...
    <div className="container mx-auto px-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <a
            href="https://wa.me/5511945806717?text=Olá! Gostaria de solicitar um orçamento."
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="border-t border-primary-foreground/10 pt-6 text-center">
            ...
            <a
              href="mailto:comercial@jobelly.com.br"
